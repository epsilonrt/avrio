 ...
 */
#  define KEYB_C1_DDR  DDRA
#  define KEYB_C1_PORT PORTA
#  define KEYB_C1_PIN  PINA
#  define KEYB_C1_BIT  6

#  define KEYB_C2_DDR  DDRD
#  define KEYB_C2_PORT PORTD
#  define KEYB_C2_PIN  PIND
#  define KEYB_C2_BIT  1

#  define KEYB_C3_DDR  DDRA
#  define KEYB_C3_PORT PORTA
#  define KEYB_C3_PIN  PINA
#  define KEYB_C3_BIT  7

#  define KEYB_C4_DDR  DDRD
#  define KEYB_C4_PORT PORTD
#  define KEYB_C4_PIN  PIND
#  define KEYB_C4_BIT  0

#  define KEYB_R1_DDR  DDRD
#  define KEYB_R1_PORT PORTD
#  define KEYB_R1_PIN  PIND
#  define KEYB_R1_BIT  2

#  define KEYB_R2_DDR  DDRD
#  define KEYB_R2_PORT PORTD
#  define KEYB_R2_PIN  PIND
#  define KEYB_R2_BIT  3

#  define KEYB_R3_DDR  DDRA
#  define KEYB_R3_PORT PORTA
#  define KEYB_R3_PIN  PINA
#  define KEYB_R3_BIT  5

#  define KEYB_R4_DDR  DDRA
#  define KEYB_R4_PORT PORTA
#  define KEYB_R4_PIN  PINA
#  define KEYB_R4_BIT  4

...
/*
 * Vecteur d'interruption utilisé par le module tâche
...
vKernelHardwareInit (void) {
   ...
   * Période de reccurrence des it = 1 ms soit 16000 périodes d'horloge
   * 16000 / 64 = 250 donc division par 64 et OCR0 = 250 - 1 = 249
   */
  OCR0 = (uint8_t) (AVRIO_CPU_FREQ / AVRIO_KERNEL_TICK_RATE / 64) - 1;
  TCCR0 = 0x0B; /* mode CTC, N = 64 */
}

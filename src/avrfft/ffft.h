/* Copyright _  2005-2011 ChaN. All rights reserved.
   Copyright _  2011 epsilonRT. All rights reserved.
   $Id$ */
#ifndef _AVRFFT_FFFT_H_
#define _AVRFFT_FFFT_H_
/* ========================================================================== */
...
#include <avr/pgmspace.h>
  ...
  #ifndef INPUT_NOUSE
    /**
     * Fills the complex array with a wave form to prepare butterfly operations.
     * A hamming window is applied at the same time.
     */
    #ifdef INPUT_IQ
  ...
  /**
   * Executes the butterfly operations
   */
  void fft_execute (complex_t *);
  
  /**
   * Re-orders the results, converts the complex spectrum into scalar spectrum
   * and output it in linear scale
   */

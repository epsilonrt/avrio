...
/* setup timing ============================================================= */
#if (OCR(BAUD,1) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS1)
#define PRESCALER 1
#define TIMER_CS SERIAL_SW_CS1
#elif (OCR(BAUD,8) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS8)
#define PRESCALER 8
#define TIMER_CS SERIAL_SW_CS8
#elif (OCR(BAUD,32) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS32)
#define PRESCALER 32
#define TIMER_CS SERIAL_SW_CS32
#elif (OCR(BAUD,64) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS64)
#define PRESCALER 64
#define TIMER_CS SERIAL_SW_CS64
#elif (OCR(BAUD,128) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS128)
#define PRESCALER 128
#define TIMER_CS SERIAL_SW_CS128
#elif (OCR(BAUD,256) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS256)
#define PRESCALER 256
#define TIMER_CS SERIAL_SW_CS256
#elif (OCR(BAUD,1024) <= SERIAL_SW_TIMER_MAX) && defined(SERIAL_SW_CS1024)
...
#define WAIT_ONE        OCR(BAUD,PRESCALER)

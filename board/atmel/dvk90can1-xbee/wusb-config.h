/* Copyright © 2008-2012 epsilonRT. All rights reserved.
   All rights reserved. */
...
/* constants ================================================================ */
#define WUSB_CONFIG_EEPROM_ENABLE /* Valide la mémorisation en EEPROM de la configuration */
...
//#define WUSB_CONFIG_DEVICE_RSSI_ENABLE
 ...
 *                         Sensor Config                                     *
 *===========================================================================*/
#define WUSB_CONFIG_SENSOR_NACK_RETRIES         10   // 1-7,Number of TX with random delay
#define WUSB_CONFIG_SENSOR_BIND_CYCLES          2
#define WUSB_CONFIG_SENSOR_SEARCH_CHANNEL_DELAY 20  // Number of ms between each channel change

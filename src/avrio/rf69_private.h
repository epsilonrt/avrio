/**
 * @file rf69_private.h
 * @brief Registers definitions for HopeRF RFM69W/RFM69HW, Semtech SX1231/1231H
 *
...
void vRf69TimerStop (timer_t t);
bool bRf69Timeout (timer_t t);
...
#endif /*_AVRIO_RF69_PRIVATE_H_ defined */

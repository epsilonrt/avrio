...
typedef enum {
  ...
  XBEE_PKT_CMD_OK = 0,
  XBEE_PKT_CMD_ERROR = 1,
  XBEE_PKT_CMD_INVALID_COMMAND = 2,
  XBEE_PKT_CMD_INVALID_PARAMETER = 3,
  XBEE_PKT_CMD_TX_FAILURE = 4,
  XBEE_PKT_CMD_UNKNOWN = -1
} eXBeeCmdStatus;
...
typedef enum {
  ...
  XBEE_PKT_MODEM_MODEM_CONFIGURATION_CHANGED = 0x11,

 ...
 *
 * @file ledrgb_tlc59116.c
 * @brief LED RGB (Contrôleur TI TLC59116)
 *
 * Revision History ------------------------------------------------------------
...
// -----------------------------------------------------------------------------
void 
vLedRgbSetColor (xLedRgbMask xLed, uint32_t ulColor) {
  uint8_t ucCtrlIndex;
  uint16_t usLed;
...
// -----------------------------------------------------------------------------
void 
vLedRgbSetMode  (xLedRgbMask xLed, eLedRgbMode eMode) {
  uint8_t ucCtrlIndex;
  uint16_t usLed;
...
xLedRgbMask 
xLedRgbError (void) {
  xLedRgbMask xError = 0, xCtrlError;
  uint8_t ucCtrlIndex;

...
#define LCD_PIO_RS_PORT    PORTA
#define LCD_PIO_RS_DDR     DDRA

#define LCD_PIO_E_PORT     PORTA
#define LCD_PIO_E_DDR      DDRA

#define LCD_PIO_RW_PORT    PORTA
#define LCD_PIO_RW_DDR     DDRA

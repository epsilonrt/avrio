...
#define LCD_PIO_RS_BIT   0
#define LCD_PIO_E_BIT    2
#define LCD_PIO_RW_BIT   1
//#define LCD_PIO_RD_BIT   7

/* - Ports utilisés en PIO - */
#define LCD_PIO_DATA_PORT  PORTB
#define LCD_PIO_DATA_DDR   DDRB

#define LCD_PIO_RS_PORT    PORTB
#define LCD_PIO_RS_DDR     DDRB

#define LCD_PIO_E_PORT     PORTB
#define LCD_PIO_E_DDR      DDRB

#define LCD_PIO_RW_PORT    PORTB
#define LCD_PIO_RW_DDR     DDRB

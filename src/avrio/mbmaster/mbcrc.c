...
USHORT
usMBMCRC16( UCHAR * pucFrame, USHORT usLen )
{
    UCHAR           ucCRCHi = 0xFF;
    UCHAR           ucCRCLo = 0xFF;
    int             iIndex;
    ...
    return ( ( ( USHORT )ucCRCHi << 8U ) | ( USHORT )ucCRCLo ); 
}

USHORT
usMBSCRC16( UCHAR * pucFrame, USHORT usLen )
{
	return usMBMCRC16( pucFrame, usLen );
}
